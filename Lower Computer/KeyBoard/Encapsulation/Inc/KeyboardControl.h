...
#define KEYBOARD_3_AND_ 32 // KEYBOARD 3 AND # 
#define KEYBOARD_4_AND_DOLLAR 33 // KEYBOARD 4 AND $ 
#define KEYBOARD_5_AND_PERCENTAGESIGN 34 // KEYBOARD 5 AND % 
...
#define KEYBOARD_9_AND_ 38 // KEYBOARD 9 AND ( 
#define KEYBOARD_0_AND_ 39 // KEYBOARD 0 AND ) 
